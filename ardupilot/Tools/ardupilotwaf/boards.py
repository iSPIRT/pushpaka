...
#                '-Werror=shorten-64-to-32',  # ARRAY_SIZE() creates this all over the place as the caller typically takes a uint32_t not a size_t
        ...
        if self.with_can:
            ...
            if cfg.options.trusted_flight_issuer and cfg.options.trusted_flight_root_certificate:
                ...
                from AP_PushpakaTrustedFlight.utils.helpers import get_certificate_from_file, validate_certificate
                ...
                mbedtls_config_file = cfg.srcnode.find_dir('libraries/AP_PushpakaTrustedFlight').abspath() + '/trusted_flight_mbedtls_config.h'

                env.CXXFLAGS += ['-DAP_PUSHPAKA_TRUSTED_FLIGHT_ENABLED']            
                env.DEFINES.update(
