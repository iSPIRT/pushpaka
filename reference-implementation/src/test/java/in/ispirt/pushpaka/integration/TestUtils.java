...
public class TestUtils {
  ...
  public static boolean grantCAAAdmin(AuthZ authZ , UUID CAAResourceID, UUID platformAdminUserID, UUID CAAAdminUserID) {
    boolean isSuccess = false;
    isSuccess = authZ.createResoureTypeAdminByPlatformUser(
        ResourceType.CAA,
