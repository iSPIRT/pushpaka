...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "in.ispirt.pushpaka.registry.config.EnumConverterConfiguration.stateConverter")
    ...
    @Bean(name = "in.ispirt.pushpaka.registry.config.EnumConverterConfiguration.uasPropulsionCategoryConverter")
    ...
    @Bean(name = "in.ispirt.pushpaka.registry.config.EnumConverterConfiguration.uasWeightCategoryConverter")
