...
public class SpringDocConfiguration {
    ...
    OpenAPI apiInfo() {
        return new OpenAPI()
                ...
                .components(
                        new Components()
                                .addSecuritySchemes("registry_auth", new SecurityScheme()
