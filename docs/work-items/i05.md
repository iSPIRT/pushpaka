...
| Phase | Name | Services                                                     | Timeline            |
| ----- | ---- | ------------------------------------------------------------ | ------------------- |
| 1     | M0   | Registration, Restriction Management V0, Incident Reporting  | Till Feb 2022       |
| 2     | M1   | Communication and Navigation, Flight Awareness, Permission Management, Discovery, Airspace Authorisation, Messaging | Feb 2022 - Feb 2023 |
| 3     | M2   | Flight Notification, Strategic Deconfliction, Conflict Advisory and Alert, Dynamic Airspace Density, Weather | Feb 2023 - Feb 2024 |
| 4     | M3   | Emergency Management, Conformance Monitoring, Restriction Management V1, Log Management, Interface with ATC, Swarm Management, Corridor Management | Feb 2024 - Feb 2025 |

### Phases (detail)

| Phase | Service                      | Description                                                  | Timeline      |
| ----- | ---------------------------- | ------------------------------------------------------------ | ------------- |
| 1     | Registration                 | Pilot, Manufacturer Org., Training Org., Operator Org. registration and profile management | Till Feb 2022 |
|       | Restriction Management V0    | Airspace Rules                                               |               |
|       | Incident Reporting           |                                                              |               |
| 2     | Communication and Navigation |                                                              | Till Feb 2023 |
...
| 3     | Flight Notification          | Get flights in AOI                                           | Till Feb 2024 |
...
| 4     | Emergency Management         | UVR/NOTAM/TFR preemption rules                               | Till Feb 2025 |
