# Draft Concept of Operations Version 1
...
The suggested approach for India, based on an incremental risk-based technique, should fall broadly under the following steps: -
...
The operational limits of the Category A for India are defined as follows: 
