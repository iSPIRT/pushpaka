...
public interface LegalEntityApi {
   ...
   */
    ...
    default ResponseEntity<LegalEntity>
    addLegalEntity(
        @Parameter(
            name = "LegalEntity",
            description = "Create a new legalEntity in the store",
            required = true) @Valid @RequestBody LegalEntity legalEntity) {
      // getRequest()
      //   .ifPresent(
      //     request -> {
   ...
   */
    @Operation(
        ...
        description = "",
        tags = {"legalEntity"},
        responses = { @ApiResponse(responseCode = "400", description = "Invalid legalEntity value") },
        security = { @SecurityRequirement(
                         name = "registry_auth",
                         scopes = {"write:legalEntitys", "read:legalEntitys"}) })
    ...
    deleteLegalEntity(
        @Parameter(
            ...
            required = true,
            in = ParameterIn.PATH) @PathVariable("legalEntityId") UUID legalEntityId) {
   ...
   */
    ...
    @RequestMapping(
        ...
        produces = {"application/json"})
    default ResponseEntity<List<LegalEntity>>
    findLegalEntitys() {
      // getRequest()
      //   .ifPresent(
      //     request -> {
   ...
   */
    @Operation(
        ...
        responses = { @ApiResponse(
                      ...
                      ,
                          @ApiResponse(responseCode = "400", description = "Invalid ID supplied"), @ApiResponse(responseCode = "404", description = "LegalEntity not found") },
        security = { @SecurityRequirement(
                         name = "registry_auth",
                         scopes = {"write:legalEntitys", "read:legalEntitys"}) })
    @RequestMapping(
