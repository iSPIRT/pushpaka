...
public interface UasTypeApi {
   ...
   */
    ...
    default ResponseEntity<UasType>
    addUasType(
        @Parameter(
            name = "UasType",
            description = "Create a new uasType in the store",
            required = true) @Valid @RequestBody UasType uasType) {
      // getRequest()
      //     .ifPresent(
      //         request -> {
   ...
   */
    @Operation(
        ...
        description = "",
        tags = {"uas_types"},
        responses = { @ApiResponse(responseCode = "400", description = "Invalid uasType value") },
        security = { @SecurityRequirement(
                         name = "registry_auth",
                         scopes = {"write:uasTypes", "read:uasTypes"}) })
    ...
    deleteUasType(
        @Parameter(
            ...
            required = true,
            in = ParameterIn.PATH) @PathVariable("uasTypeId") UUID uasTypeId) {
   ...
   */
    ...
    @RequestMapping(
        ...
        value = "/uasType/find",
        produces = {"application/json"})
    default ResponseEntity<List<UasType>>
    findUasTypes() {
      // getRequest()
      //     .ifPresent(
      //         request -> {
   ...
   */
    @Operation(
        ...
        responses = { @ApiResponse(
                      ...
                      ,
                          @ApiResponse(responseCode = "400", description = "Invalid ID supplied"), @ApiResponse(responseCode = "404", description = "UasType not found") },
   ...
   */
    @Operation(
        ...
        responses = { @ApiResponse(
                      ...
                      ,
                          @ApiResponse(responseCode = "400", description = "Invalid ID supplied"), @ApiResponse(responseCode = "404", description = "UasType not found"), @ApiResponse(responseCode = "405", description = "Validation exception") },
        security = { @SecurityRequirement(
                         name = "registry_auth",
                         scopes = {"write:uasTypes", "read:uasTypes"}) })
    @RequestMapping(
   ...
   */
    ...
    updateUasTypeWithForm(
        ...
        @Parameter(
            ...
            in = ParameterIn.QUERY) @Valid @RequestParam(value = "name", required = false) String name,
        @Parameter(
            name = "status",
   ...
   */
    ...
    default ResponseEntity<ModelApiResponse>
    uploadFile(
        @Parameter(
            name = "uasTypeId",
        ...
        @Parameter(
            ...
            in = ParameterIn.QUERY) @Valid @RequestParam(value = "additionalMetadata",
            required = false) String additionalMetadata,
        @Parameter(name = "body", description = "") @Valid @RequestBody(
            required = false) org.springframework.core.io.Resource body) {
      getRequest()
          .ifPresent(
              request -> {
                for (MediaType mediaType : MediaType.parseMediaTypes(
